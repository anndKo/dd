...
const ClassDetailModal = ({ classInfo, onClose }: ClassDetailModalProps) => {
  ...
  }, [attendanceRecords, attendanceWeekFilter, attendanceSearch]);
        ...
        <div className="flex-1 overflow-hidden flex flex-col">
          <Tabs defaultValue="students" className="h-full flex flex-col">
            ...
            <TabsContent value="students" className="flex-1 overflow-hidden flex flex-col mt-4 px-4 md:px-6 pb-4 md:pb-6">
              ...
              <div className="flex-1 overflow-auto min-h-0" style={{ maxHeight: 'calc(100vh - 400px)', minHeight: '300px' }}>
                {isLoading ? (
            ...
            <TabsContent value="attendance" className="flex-1 overflow-hidden flex flex-col mt-4 px-4 md:px-6 pb-4 md:pb-6">
              ...
              <div className="mb-3 shrink-0">
                ...
                {attendanceSearch && (
                  <p className="text-xs text-muted-foreground mt-1">
                    Tìm thấy {filteredAttendanceRecords.length} kết quả cho "{attendanceSearch}" - hiển thị tất cả tuần
                  </p>
                )}
              </div>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <p>{attendanceSearch ? "Không tìm thấy kết quả" : "Chưa có ai điểm danh"}</p>
                </div>
              ) : (
                <div className="flex-1 overflow-auto" style={{ maxHeight: 'calc(100vh - 350px)', minHeight: '300px' }}>
                  {/* Group records by week if filter is null and no search */}
                  {attendanceWeekFilter === null && !attendanceSearch ? (
